...
const Contact: React.FC = () => {
  ...
  return (
    ...
    //     Contact
    //   </h2>
    //   <div className="flex-1 flex flex-col lg:flex-row space-x-16 justify-between gap-x-24 items-center ">
    //     {/* AVATAR */}
    //     <div className="w-full  p-4  lg:ms-16 order-1 lg:order-2">
    //       <Image width="450" height="550" src={avatar} alt="email abatar" />
    //     </div>
    //     {/* FORM */}
    //     <div className="w-full  p-4 order-2 lg:order-1">
    //       <h3 className="text-4xl font-bold mb-6 text-glowinglime text-shadow-glow text-center">
    //         Reach Me Out
    //       </h3>
    //       <p className="text-lg text-gray-300 text-center mb-10">
    //         Feel free to reach out for inquiries or collaboration. I&apos;d love
    //         to connect with you!
    //       </p>
    //       <form
    //         onSubmit={handleSubmit(onSubmit)}
    //         className="space-y-6 bg-gray-800 p-8 rounded-lg shadow-lg mx-auto max-w-2xl"
    //       >
    //         <input
    ...
    //         <button
    //           type="submit"
    //           className="bg-glowinglime text-black p-3 w-full rounded-lg font-semibold hover:shadow-glow transition-transform transform hover:scale-105 duration-300"
    //         >
    //           Send Message
    //         </button>
    //       </form>
        ...
        <div className="flex-1 flex flex-col lg:flex-row space-y-8 lg:space-y-0 lg:space-x-16 justify-between items-center relative z-10">
          ...
          <div className="w-full lg:w-1/2 p-4 lg:ms-16 order-1 lg:order-2 transform hover:scale-105 transition-transform duration-500 ease-in-out">
            <Image
              ...
              src={avatar}
              alt="email avatar"
              className="rounded-b-full rounded-tr-full rounded-tl-xl  shadow-xl hover:shadow-2xl transition-all duration-300"
            />
          </div>
          {/* FORM */}
