					...
					<div className="w-full lg:w-1/2 lg:p-0  p-4 order-2 lg:order-1">
						...
						>
							<input
								...
								className="w-full p-4 rounded-lg bg-gray-900 text-white focus:outline-none focus:ring-2 focus:ring-glowinglime transition-all duration-300 placeholder-gray-500 outline-none"
							/>
							<input
							...
							<textarea
								...
								className="w-full p-4 h-40 rounded-lg bg-gray-900 text-white focus:outline-none focus:ring-2 focus:ring-glowinglime transition-all duration-300 placeholder-gray-500 outline-none"
							/>
							<button
								type="submit"
								className="font-bold  text-black bg-white  p-3 w-full rounded-lg hover:shadow-glow transition-transform transform  duration-300 ease-in"
							>
								Send Message
							</button>
						</form>
