...
const Footer: React.FC = () => {
	const menues = [
		...
		{ to: "contact", value: "Contact Me" },
	];
	return (
		<footer className="bg-gray-900 text-white py-8 px-4 relative z-[1000]">
						...
						{menues.map((menu) => (
							<li key={menu.to}>
								<Link
									...
									offset={50}
									duration={500}
									className="hover:text-glowinglime transition-all duration-300 cursor-pointer"
								>
									{menu.value}
								</Link>
							</li>
